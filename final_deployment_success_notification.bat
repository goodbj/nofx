...
echo      状态: 正在运行
echo      端口: 8888
echo   ✅ 前端容器: nofx-dev-frontend-display
echo      状态: 正在运行
echo      端口: 3300
echo.
echo 功能特性：
...
echo.
echo 控制命令：
echo   🛑 停止服务: docker compose -f docker-compose.dev.web.display.yml down
echo   🔄 查看日志: docker compose -f docker-compose.dev.web.display.yml logs -f
echo   🔍 检查状态: docker ps
echo.
echo 提示：
...
echo   • 现在您可以访问 http://localhost:3300 登录和使用网站
echo.
echo ===============================================
echo    部署成功！您可以开始使用了。
echo ===============================================
