...
透明代理服务是一个高性能的Docker容器，用于转发nofx到交易所API的请求。该服务旨在绕过地区限制，使nofx能够在受限地区访问交易所API。

## 🚀 性能优化版本

**最新优化特性**:
- 🔧 **连接池优化**：支持200个空闲连接，提升并发性能
- ⚡ **并发控制**：最大100个并发请求，防止资源耗尽  
- 📝 **异步日志**：非阻塞日志处理，提升响应速度
- 💾 **内存池优化**：32KB缓冲区复用，减少GC压力
- 📦 **响应压缩**：HTTP压缩传输，节省带宽
...
详细部署说明请参阅：[DOCKER_DEPLOYMENT_GUIDE.md](DOCKER_DEPLOYMENT_GUIDE.md)
...
✅ **热更新支持**：开发环境支持代码实时更新
✅ **Docker部署**：容器化部署，易于管理和扩展
✅ **健康监控**：内置健康检查端点 `/health`
