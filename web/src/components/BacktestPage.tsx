...
import { UNIFIED_ACTION_CONFIG, formatPrice, getConfidenceColor, formatNumber } from './UnifiedTradeActionDisplay'
  ...
  return (
    <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
      {recentTrades.map((trade, idx) => {
        const config = UNIFIED_ACTION_CONFIG[trade.action] || UNIFIED_ACTION_CONFIG.wait
        ...
        const actionData = {
          ...
          price: trade.price,
          confidence: 80, // 默认置信度
          reasoning: `${trade.action} trade executed`,
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{
                    background: `${getConfidenceColor(actionData.confidence)}22`,
                    color: getConfidenceColor(actionData.confidence)
                  }}
                >
                ...
                <div
                  ...
                  style={{ background: trade.realized_pnl >= 0 ? '#0ECB81' : '#F6465D' }}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-4 gap-3 mt-3 pt-3" style={{ borderTop: '1px solid #2B3139' }}>
              ...
              <div className="text-center">
                <div className="text-xs mb-1" style={{ color: '#848E9C' }}>
                  {isOpen ? 'Leverage' : 'Quantity'}
                </div>
                <div className="font-mono font-semibold" style={{ color: isOpen ? '#F0B90B' : '#EAECEF' }}>
                  {isOpen ? `${trade.leverage}x` : trade.qty.toFixed(4)}
                </div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="font-mono font-semibold" style={{ color: trade.realized_pnl >= 0 ? '#0ECB81' : '#F6465D' }}>
              ...
              <div className="text-center">
                ...
                <div className="text-xs font-mono" style={{ color: '#EAECEF' }}>
            ...
            {/* Timestamp */}
            <div className="mt-3 pt-3 text-xs text-center" style={{ color: '#848E9C', borderTop: '1px solid #2B3139' }}>
