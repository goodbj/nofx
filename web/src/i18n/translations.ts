...
export const translations = {
  en: {
    ...
    faqNav: 'FAQ',
    testCodeNav: 'Tests',
    test_scripts_tab: 'Test Scripts',
    test_page_title: 'System Test Dashboard',
    batch_trade_tab: 'Batch Trading',
    api_test_tab: 'API Test',
    ...
    select_trader_label: 'Select Trader',
    please_select_trader: 'Please select a trader',
    please_select_trader_error: 'Error: Please select a trader first.',
    trade_action_templates: 'Trade Action Templates',
    ...
    batch_commands_label: 'Batch JSON Commands',
    example_instructions: 'Format: Array of decision objects',
    executing: 'Executing...',
    execute_batch: 'Execute Batch Commands',
    batch_execution_results: 'Batch Execution Results',
    available_test_scripts: 'Available Test Scripts',
    no_scripts_found: 'No test scripts found in test/ directory',
    refresh_list: 'Refresh List',
    execution_output: 'Execution Output',
    no_output_yet: 'No output yet. Click "Run" to start a test.',
    run: 'Run',
    json_parse_error: 'JSON Parse Error: ',
    not_authenticated: 'Error: Not authenticated. Please log in first.',
    error_occurred: 'An error occurred: ',
    open_long_btc: 'Open Long (BTC)',
    buy_btc_long: 'Buy BTC Long',
    open_long_eth: 'Open Long (ETH)',
    buy_eth_long: 'Buy ETH Long',
    open_long_sol: 'Open Long (SOL)',
    buy_sol_long: 'Buy SOL Long',
    open_short_btc: 'Open Short (BTC)',
    sell_btc_short: 'Sell BTC Short',
    open_short_eth: 'Open Short (ETH)',
    sell_eth_short: 'Sell ETH Short',
    open_short_sol: 'Open Short (SOL)',
    sell_sol_short: 'Sell SOL Short',
    close_long_btc: 'Close Long (BTC)',
    close_btc_long: 'Close BTC Long',
    close_long_eth: 'Close Long (ETH)',
    close_eth_long: 'Close ETH Long',
    close_short_btc: 'Close Short (BTC)',
    close_btc_short: 'Close BTC Short',
    close_short_eth: 'Close Short (ETH)',
    close_eth_short: 'Close ETH Short',
    close_long_sol: 'Close Long (SOL)',
    close_sol_long: 'Close SOL Long',
    close_short_sol: 'Close Short (SOL)',
    close_sol_short: 'Close SOL Short',
    close_all_positions: 'Close All Positions',
    start_trader: 'Start Trader',
    stop_trader: 'Stop Trader',
    trader_status: 'Trader Status',
    refresh_prices: 'Refresh Prices',
    refresh_traders: 'Refresh Traders',
    manual_scan: 'Manual Scan',
    trigger_manual_scan: 'Trigger Manual AI Scan Decision',
    scanning: 'Scanning...',
    sync_balance: 'Sync Balance',
    sync_balance_desc: 'Sync actual exchange balance to DB',
    syncing: 'Syncing...',
    ...
    stop_take_combo: 'Stop/Take Combo',
    set_stop_take: 'Set Stop Loss & Take Profit',
    close_part_position: 'Close Part of Position',
    ...
    profitAmount: 'Profit/Loss Amount',
    profit: 'Profit',
    loss: 'Loss',
    ...
    clickToRunTest: 'Click to run AI test',
  ...
  zh: {
    ...
    faqNav: '常见问题',
    testCodeNav: '测试代码',
    test_scripts_tab: '测试脚本',
    test_page_title: '系统测试控制台',
    batch_trade_tab: '批量交易测试',
    api_test_tab: 'API连接测试',
    api_key_label: 'API 密钥 (Key)',
    secret_key_label: '私钥 (Secret)',
    api_url_label: 'API 地址',
    run_test: '运行连接测试',
    running_test: '正在运行...',
    test_results: '测试结果',
    select_trader_label: '选择交易员',
    please_select_trader: '请选择一个交易员',
    please_select_trader_error: '错误：请先选择一个交易员。',
    trade_action_templates: '交易动作模板库',
    current_btc_price: '当前 BTC 价格: ',
    fetching: '获取中...',
    seconds_remaining: '秒后可刷新',
    get_current_price: '获取实时价格',
    long_positions: '多仓操作',
    short_positions: '空仓操作',
    general_operations: '通用操作',
    advanced_operations: '高级操作',
    batch_commands_label: '批量 JSON 指令',
    example_instructions: '格式：包含决策对象的数组',
    executing: '执行中...',
    execute_batch: '执行批量指令',
    batch_execution_results: '批量执行结果',
    available_test_scripts: '可用测试脚本列表',
    no_scripts_found: '在 test/ 目录中未找到测试脚本',
    refresh_list: '刷新列表',
    execution_output: '执行输出日志',
    no_output_yet: '暂无输出。点击“运行”开始测试。',
    run: '运行',
    json_parse_error: 'JSON 解析错误: ',
    not_authenticated: '错误：未登录。请先登录。',
    error_occurred: '发生错误：',
    open_long_btc: '开多 (BTC)',
    buy_btc_long: '买入 BTC 做多',
    open_long_eth: '开多 (ETH)',
    buy_eth_long: '买入 ETH 做多',
    open_long_sol: '开多 (SOL)',
    buy_sol_long: '买入 SOL 做多',
    open_short_btc: '开空 (BTC)',
    sell_btc_short: '卖出 BTC 做空',
    open_short_eth: '开空 (ETH)',
    sell_eth_short: '卖出 ETH 做空',
    open_short_sol: '开空 (SOL)',
    sell_sol_short: '卖出 SOL 做空',
    close_long_btc: '平多 (BTC)',
    close_btc_long: '平掉 BTC 多仓',
    close_long_eth: '平多 (ETH)',
    close_eth_long: '平掉 ETH 多仓',
    close_short_btc: '平空 (BTC)',
    close_btc_short: '平掉 BTC 空仓',
    close_short_eth: '平空 (ETH)',
    close_eth_short: '平掉 ETH 空仓',
    close_long_sol: '平多 (SOL)',
    close_sol_long: '平掉 SOL 多仓',
    close_short_sol: '平空 (SOL)',
    close_sol_short: '平掉 SOL 空仓',
    close_all_positions: '全平 (所有持仓)',
    start_trader: '启动交易员',
    stop_trader: '停止交易员',
    trader_status: '交易员状态',
    refresh_prices: '刷新价格',
    refresh_traders: '刷新列表',
    manual_scan: '手动扫盘',
    trigger_manual_scan: '手动触发 AI 扫盘决策',
    scanning: '扫盘中...',
    sync_balance: '同步余额',
    sync_balance_desc: '从交易所同步实际余额到数据库',
    syncing: '同步中...',
    hold_position: '继续持仓',
    maintain_position: '保持当前仓位不变',
    wait_and_watch: '观望等待',
    wait_for_opportunity: '等待更好的入场时机',
    modify_stop_loss: '修改止损',
    modify_take_profit: '修改止盈',
    stop_take_combo: '止盈止损组合',
    set_stop_take: '同时设置止损和止盈',
    close_part_position: '部分平仓',
    trailing_stop: '追踪止损',
    trailing_stop_desc: '价格随利润移动的动态止损',
    dynamic_take_profit: '动态止盈',
    dynamic_take_profit_desc: '根据市场动态调整止盈目标',
    oco_order: 'OCO订单',
    oco_order_desc: '一取消全取消订单',
    bracket_order: '括号订单',
    bracket_order_desc: '同时设置入场、止损和止盈',
    add_to_position: '加仓',
    add_to_position_desc: '向现有仓位增加头寸',
    partial_close: '部分平仓',
    ...
    partialClose: '部分平仓',
    updateStopLoss: '更新止损',
    updateTakeProfit: '更新止盈',
    trailingStop: '追踪止损',
    dynamicTakeProfit: '动态止盈',
    addPosition: '加仓',
    fullClose: '全平',
    ...
    aiReasoning: 'AI推理',
    aiDecisions: 'AI决策',
    rawAiResponse: '原始AI响应',
    duration: '耗时',
    aiTest: 'AI测试',
    runAiTest: '运行AI测试',
    testResults: '测试结果',
    clickToRunTest: '点击运行AI测试',
